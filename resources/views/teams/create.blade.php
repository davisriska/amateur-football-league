...
@section('js')
    ...
    <script>
        var pleyerSelectValue = {!! json_encode(array_map('strval', old('players',[]))) !!};
        var trainerSelectValue = {!! json_encode(array_map('strval', old('trainers',[]))) !!};
    </script>
    <script src="/js/teams_create.js"></script>
@endsection