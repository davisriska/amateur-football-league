<div class="modal fade" tabindex="-1" role="dialog" id="results_updateModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="results_updateModal_form" action="{{route('results@update')}}">
                <div class="modal-body">

                    <div class="alert alert-danger" style="display: none">
                        <ul id="results_updateModal_errors">
